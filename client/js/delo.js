...
function toFilter(need, source, dateFrom, dateTo) {
    ...
    console.log("ajax go");
    $.ajax({
        // url: "http://localhost:7788?" +"need="+need+
        // "&source="+source+"&dateFrom="+dateFrom+"&dateTo="+dateTo,
        url:"http://localhost:7788/?need=search&source=table&dateFrom=01/01/1998&dateTo=01/01/2018",
        // type: "GET", contentType: "application/json",
        method: 'GET',
        // type: "GET", contentType: "application/json",
        type: "GET", contentType: "application/text",
